...
const ModifierAnalyse = ({ navigation, route }) => {
    ...
    return (
      <>
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>Modifier votre analyse</Text>
        </View>
...
<View>
                    ...
                    <View style={{ justifyContent: 'center' }}>
                      {!isSubmitting && (
                        <RegularButton onPress={handleSubmit} style={{ justifyContent: 'center', alignSelf: 'center' }}>
